...
/**
 * The included tip amount and currency formatted for the current system locale, using the NumberFormat.
 * @since 2.22.0
 */
@property (strong, readonly, nonatomic, nonnull) MPReceiptLineItem *includedTipAmountAndCurrency;
...
/**
 * Indicates if a tip line must be present on the receipt.
 * @since 2.22.0
 */
@property (assign, readonly, nonatomic) BOOL printTipLine;
 ...
 * @since 2.1.0
 */
@property (strong, readonly, nonatomic, nonnull) NSArray<MPReceiptLineItem*> *clearingDetails;
 ...
 * @since 2.1.0
 */
@property (strong, readonly, nonatomic, nonnull) NSArray<MPReceiptLineItem*> *paymentDetails;
 ...
 * @since 2.1.0
 */
@property (strong, readonly, nonatomic, nonnull) NSArray<MPReceiptLineItem*> *merchantDetails;
