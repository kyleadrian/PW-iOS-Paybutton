 ...
 * @since 2.18.0
 */
typedef void (^MPAccessoryProcessStatusChanged)(MPAccessoryProcess * _Nonnull accessoryProcess, MPAccessory * _Nullable accessory, MPAccessoryProcessDetails * _Nonnull details);
