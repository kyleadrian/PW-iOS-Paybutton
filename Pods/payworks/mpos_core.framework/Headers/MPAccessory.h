...
typedef NS_ENUM(NSUInteger, MPAccessoryType){
    ...
    /** Verifone E355 */
    MPAccessoryTypeVerifoneE355,
    /** Verifone VX820 */
    MPAccessoryTypeVerifoneVX820,
    /** Sewoo LKP21 */
    ...
    /** Ingenico Lane2500 */
    MPAccessoryTypeIngenicoLink2500,
    /** Ingenico Link5000 */
    MPAccessoryTypeIngenicoLane5000
};
...
typedef NS_ENUM(NSUInteger, MPAccessoryFamily){
    ...
    /** Use the Ingenico series */
    MPAccessoryFamilyIngenico
};
...
typedef NS_OPTIONS(NSUInteger, MPAccessoryComponentType) {
    ...
    MPAccessoryComponentTypePrinter             = 1 << 1,
    /** Log access component available */
    MPAccessoryComponentTypeLog                 = 1 << 2,
    /** Tipping component available*/
    MPAccessoryComponentTypeTipping             = 1 << 3,
    /** Interaction component available */
    MPAccessoryComponentTypeInteraction         = 1 << 4
};
...
/** 
 * Accessory parameters that where used to create this accessory
 * @since 2.18.0
 */
@property (strong, readonly, nonatomic, nonnull) MPAccessoryParameters *parameters;
