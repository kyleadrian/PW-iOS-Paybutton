 ...
 * @since 2.27.0
 */
@property (nonatomic, assign) MPTransactionWorkflowType workflow;

@end


/**
 * Protocol implemented by the optionals object, on which additional parameters for an activation transaction can be set
 * @see MPTransactionParameters for parameters description
 * @since 2.32.0
 */
@protocol MPTransactionParametersActivationOptionals <MPTransactionParametersBasicOptionals>
    
@end


/**
 * Protocol implemented by the optionals object, on which additional parameters for a standalone account verification transaction can be set
 * @see MPTransactionParameters for parameters description
 * @since 2.27.0
 */
@protocol MPTransactionParametersAccountVerificationOptionals<MPTransactionParametersBasicOptionals>
...
/**
 * Optionals callback definition, providing access to an object to set optional parameters for an activation.
 * @param optionals Object to set optional parameters on.
 * @since 2.32.0
 */
typedef void (^MPTransactionParametersActivationOptionalsBlock)(id<MPTransactionParametersActivationOptionals>_Nonnull optionals);
...
/**
 * Optionals callback definition, providing access to an object to set optional parameters for a account verification transaction.
 * @param optionals Object to set optional parameters on.
 * @since 2.27.0
 */
typedef void (^MPTransactionParametersAccountVerificationOptionalsBlock)(id<MPTransactionParametersAccountVerificationOptionals>_Nonnull optionals);
 ...
 * @since 2.5.0
 */
@property (nonatomic, readonly, copy, nullable) NSDictionary<NSString*, NSString*> *metadata;
...
/**
 * Determines workflow for a transaction. Is unknown by default
 * @since 2.27.0
 */
@property (nonatomic, readonly, assign) MPTransactionWorkflowType workflow;
...
/**
 * Creates parameters for a new, activation transaction.
 * @param amount The amount of the transaction
 * @param currency The currency of the transaction
 * @param optionalsBlock A block that has one argument - an object on which optional parameters can be set. Can be null.
 * @return A new transaction parameters object that can be used to start an activation transaction
 * @throws NSException if amount is nil or NaN
 * @since 2.32.0
 */
+ (nonnull instancetype)activationWithAmount:(nonnull NSDecimalNumber*)amount currency:(MPCurrency)currency optionals:(nullable MPTransactionParametersActivationOptionalsBlock)optionalsBlock;
...
/**
 * Creates parameters for a new verification transaction.
 * @param currency The currency of the transaction
 * @param optionalsBlock A block that has one argument - an object on which optional parameters can be set. Can be null.
 * @return A new transaction parameters object that can be used to start a transaction
 * @since 2.27.0
 */
+ (nonnull instancetype)accountVerificationWithCurrency:(MPCurrency)currency optionals:(nullable MPTransactionParametersAccountVerificationOptionalsBlock)optionalsBlock;
