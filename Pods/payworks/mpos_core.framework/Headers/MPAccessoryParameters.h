...
/**
 * Keep alive the accessory connection after a transaction is completed
 * @since 2.18.0
 */
...
// Keys used for additional connection values stored in filters
//
 ...
 * @since 2.18.0
 */
@property (assign, readonly, nonatomic) BOOL keepAlive;
