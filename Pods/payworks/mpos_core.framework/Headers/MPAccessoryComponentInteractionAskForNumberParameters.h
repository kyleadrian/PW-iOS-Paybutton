...
typedef NS_ENUM(NSUInteger, MPAccessoryComponentInteractionPrompt) {
    ...
    MPAccessoryComponentInteractionPromptEnterTotalAmount,
    MPAccessoryComponentInteractionPromptAmount,
    MPAccessoryComponentInteractionPromptEmpty,
    MPAccessoryComponentInteractionPromptStreet,
    MPAccessoryComponentInteractionPromptZipCode
};
 ...
 * @param optionalsBlock Block that will be executed to further customize the request
 * @since 2.10.0
 */
