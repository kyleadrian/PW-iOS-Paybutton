 ...
 * Asking for tip was successful
 * @param component The component that triggered the callback
 * @param tippingAmount The amount returned by tipping accessory, total transaction amount if askForTotalAmount parameter is set or tip amount if not
 * @since 2.22.0
 */
 ...
 * @deprecated 2.22.0
 */
- (void)askForTipForAmount:(nonnull NSDecimalNumber *)transactionAmount
