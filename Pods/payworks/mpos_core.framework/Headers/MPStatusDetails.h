...
typedef NS_ENUM(NSUInteger, MPTransactionStatusDetailsCode){
    ...
    /** The transaction was accepted offline and must be send to the backend to be executed on processor if it wasn't sent already */
    ...
    /** Transaction was rejected by merchant */
    MPTransactionStatusDetailsCodeDeclinedMerchantRejected,
    /** Invalid CVN (EAN or SCV is not correct for the provided account number) */
    MPTransactionStatusDetailsCodeDeclinedInvalidCvn,
    /** Fraud count exceeded or account in fraud or watch status */
    ...
    /** Reload limit exceeded. The clerk/user location was only permitted to reload some number of accounts. That number was exceeded */
    ...
    /** The offline transaction could not be persisted */
    MPTransactionStatusDetailsCodeErrorUnableToPersistOfflineTransaction,
    /** The offline transaction was submitted with an error and will be reviewed manually */
    MPTransactionStatusDetailsCodeErrorOfflineTransactionPendingManualReview,
    /** Processor error */
    ...
    /** The terminal processing the transaction timed out */
    MPTransactionStatusDetailsCodeErrorTerminalTimeout,
    /** The terminal battery is critically low and the transaction cannot continue */
    MPTransactionStatusDetailsCodeErrorTerminalBatteryLow,

    /** The server received a transation with an invalid type (ex. a REFUND when only CHARGE is allowed) */
    MPTransactionStatusDetailsCodeErrorServerInvalidTransactionType,
    /** The server received a transaction with an invalid status */
    ...
    /** The server received a transaction with a partial refund when these are not allowed */
    MPTransactionStatusDetailsCodeErrorServerInvalidRefundAmount,
    /** The server received a transaction which is an invalid state */
