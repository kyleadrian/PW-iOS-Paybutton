...
typedef NS_OPTIONS(NSUInteger, MPPaymentAccessoryFeature){
    ...
    /** Supports styled screen */
    MPPaymentAccessoryFeatureStyledScreen                        = 1 << 13
};
 ...
 * @deprecated 2.11.0
 */
- (void)displayText:(nonnull NSArray *)text success:(nonnull MPPaymentAccessoryDisplayTextSuccess)success failure:(nonnull MPPaymentAccessoryDisplayTextFailure)failure DEPRECATED_MSG_ATTRIBUTE("Use MPAccessoryComponentInteraction.");
 ...
 * @deprecated 2.11.0
 */
- (void)displayIdleScreenWithSuccess:(nonnull MPPaymentAccessoryDisplayIdleScreenSuccess)success failure:(nonnull MPPaymentAccessoryDisplayIdleScreenFailure)failure DEPRECATED_MSG_ATTRIBUTE("Use MPAccessoryComponentInteraction.");
