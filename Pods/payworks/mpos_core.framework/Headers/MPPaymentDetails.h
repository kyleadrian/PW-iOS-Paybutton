...
typedef NS_ENUM(NSUInteger, MPPaymentDetailsSource) {
    ...
    /** The source of the payment is a barcode indicating a wallet transaction */
    MPPaymentDetailsSourceBarcode,
    /** The source of the payment is a QR Code indicating a wallet transaction */
    MPPaymentDetailsSourceQRCode
};
...
typedef NS_ENUM(NSUInteger, MPPaymentDetailsScheme){
    ...
    /** Any kind of Discover Commond Debit  */
    MPPaymentDetailsSchemeDiscoverCommonDebit,
    /** Any kind of Mastercard Common Debit */
    MPPaymentDetailsSchemeMastercardCommonDebit,
    /** Any kind of Visa Common Debit*/
    MPPaymentDetailsSchemeVisaCommonDebit,
    /** Visa Interlink */
    MPPaymentDetailsSchemeVisaInterlink,
    /** Gh-link */
    MPPaymentDetailsSchemeGhLink,
    /** Alipay wallet */
    MPPaymentDetailsSchemeAlipay,
    /** Cybersource token */
    MPPaymentDetailsSchemeCybersourceToken,
    /** Any kind of Union Pay Common Debit */
    MPPaymentDetailsSchemeUnionPayCommonDebit,
    /** Value Link */
    MPPaymentDetailsSchemeValueLink
};
...
/**
 * The payment details describe the actual account information used to complete a transactions. They differ dependent on the transaction workflow and parameters type.
 * @since 2.0.0
 */
