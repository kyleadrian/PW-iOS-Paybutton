...
/**
 * Describes the status of the tip adjustment for a transaction.
 * @since 2.22.0
 */
typedef NS_ENUM(NSUInteger, MPTransactionTipAdjustStatus) {
    MPTransactionTipAdjustStatusUnknown,
    MPTransactionTipAdjustStatusAdjustable,
    MPTransactionTipAdjustStatusNotAdjustable,
    MPTransactionTipAdjustStatusAdjusted
};
...
/**
 * Status of tip adjustment for the transaction.
 * @since 2.22.0
 */
@property(nonatomic, assign, readonly) MPTransactionTipAdjustStatus tipAdjustStatus;
