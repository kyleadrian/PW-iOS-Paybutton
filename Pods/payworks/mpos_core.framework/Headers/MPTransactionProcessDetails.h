...
typedef NS_ENUM(NSUInteger, MPTransactionProcessDetailsState){
    ...
    MPTransactionProcessDetailsStateAccepted,
    ...
    /** The transaction processing is ongoing and a card data must be input */
    MPTransactionProcessDetailsStateWaitingForCardDataInput,
    /** The transaction processing is ongoing and a address must be input */
    MPTransactionProcessDetailsStateWaitingForAddressInput,
    /** The transaction processing is ongoing and transaction verification data must be confirmed */
    MPTransactionProcessDetailsStateWaitingForVerificationDataConfirmation,
...
typedef NS_ENUM(NSUInteger, MPTransactionProcessDetailsStateDetails){
    ...
    /** The transaction was accepted offline (but still has to be submited to be apporved */
    MPTransactionProcessDetailsStateDetailsAccepted,
    /** The transaction was approved */
    ...
    /** The transaction processing is waiting for a card data input */
    MPTransactionProcessDetailsStateDetailsWaitingForCardDataInput,

    /** The transaction processing is waiting for a address input */
    MPTransactionProcessDetailsStateDetailsWaitingForAddressInput,

    /** The transaction processing is waiting for verification data confirmation */
    MPTransactionProcessDetailsStateDetailsWaitingForVerificationResultsConfirmation,
